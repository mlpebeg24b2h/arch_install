...
keys = [
    ...
    Key([mod], "Print", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/scrot.sh")),
    ...
    Key([mod, "control"], "q", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/powermenu.sh"), desc="Open Powermenu"),
    
    # Apps
    Key([mod], "Return", lazy.spawn(terminal), desc="Launch terminal"),
    Key([mod, "control"], "Return", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/applauncher.sh"), desc="Launch Rofi"),
    Key([mod], "b", lazy.spawn(browser), desc="Launch Browser"),
    Key([mod, "control"], "b", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/bravebookmarks.sh"), desc="Rofi Brave Bookmarks"),
    Key([mod], "v", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/looking-glass.sh"), desc="Start Looking Glass Client"),
    Key([mod, "shift"], "w", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/updatewal.sh"), desc="Update Theme and Wallpaper"),
    Key([mod, "control"], "w", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/wallpaper.sh"), desc="Select Theme and Wallpaper"),
    Key([mod, "control"], "t", lazy.spawn(home + "/Workspace/git/github/arch_install/dotfiles/scripts/templates.sh"), desc="Select Tempate and copy to clipboard"),
