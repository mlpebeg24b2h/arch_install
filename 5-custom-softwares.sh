...
#sudo bash -c 'echo \'log_filters="3:qemu 1:libvirt"\\' >> /etc/libvirt/libvirtd.conf'
#sudo bash -c 'echo \'log_outputs="2:file:/var/log/libvirt/libvirtd.log"\\' >> /etc/libvirt/libvirtd.conf'
